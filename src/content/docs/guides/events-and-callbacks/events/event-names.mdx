...
<Tabs syncKey="lease_transaction.unit_reserved">
  <TabItem label="Payload Properties">
      ...
      | lease_transaction_type | Type of lease transaction (e.g., "Application", "Lease Revision", "Renewal", "Notice to Vacate", "Lease Confirmation", "Transfer", "Holdover", "Lease Document Generation") | String  |          |
